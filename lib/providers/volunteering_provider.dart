...
@riverpod
Future<Map<String, Volunteering>> fetchVolunteering(FetchVolunteeringRef ref) async {
  final firestore = ref.read(firebaseFirestoreProvider);
  final collection = firestore.collection("volunteering");
  final querySnapshot = await collection.get();
  
  Map<String, Volunteering> volunteeringMap = querySnapshot.docs.fold<Map<String, Volunteering>>({}, (map, doc) {
  final data = doc.data();
