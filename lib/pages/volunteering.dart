...
class VolunteeringTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final String? activeVolunteeringId = ref.watch(currentUserProvider).when(
          data: (profile) => profile?.application?["volunteering"],
          error: (e, _) => null,
          loading: () => null,
        );
    ...
    final Volunteering? activeVolunteering =
        volunteerings.where((v) => v.id == activeVolunteeringId).firstOrNull;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          if (activeVolunteeringId != null && activeVolunteering != null)
            MyActivitySection(
              onPress: () => context.go(
                "/home/volunteerings/$activeVolunteeringId",
